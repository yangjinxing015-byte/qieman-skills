...
> **包更新日期**：2026-09-09（各文件以头部信息栏「更新日期」为准，由 `scripts/sync-updated-at.py` 同步）

且慢设计 skill 集合。官方约定：**文件夹名 = `SKILL.md` 的 `name` 字段**。L0 规范在 `SKILL.md` + `references/`（token 真源 `references/tokens.yaml`）；其余 skill 以各目录 `SKILL.md` 为准。
...
│   └── qieman-vip-advisor-visual-design   顾问物料
└── report-design/                       报告与演示
    ├── qieman-ppt-design                L2
    └── qieman-report-swipe-design       L1
```

分层：L0 token 优先，上层只补场景差异。调用路由见各分类 README：[`app-design/README.md`](app-design/README.md)、[`marketing-design/README.md`](marketing-design/README.md)、[`report-design/README.md`](report-design/README.md)。
...
| 家庭财富报告、报告翻页演示 | `qieman-ui-design` + `qieman-ppt-design` + `qieman-report-swipe-design` |
...
|------|--------|--------|------|----------|----------|
| `app-design` | `qieman-ui-design` | `qieman-ui-design` | L0 | `SKILL.md` + `references/` | 2026-09-09 |
...
| `marketing-design` | `qieman-vip-advisor-visual-design` | `qieman-vip-advisor-visual-design` | — | `SKILL.md` | — |
| `report-design` | `qieman-ppt-design` | `qieman-ppt-design` | L2 | `SKILL.md` | 2026-07-02 |
| `report-design` | `qieman-report-swipe-design` | `qieman-report-swipe-design` | L1 | `SKILL.md` | 2026-07-02 |
...
Cursor 报告翻页快捷入口：`.cursor/skills/qieman-report-swipe-design/SKILL.md`。
