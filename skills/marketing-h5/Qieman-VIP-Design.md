---
description: "且慢VIP高净值私域宣传设计 Skill。适用于高净值用户私域海报、300万+资产门槛海报、投资圈层邀请图、投研观点传播图、顾问朋友圈转发图、九宫格传播图等 9:16 竖版营销视觉与私域传播物料，并可适配市面主流 AI 生图工具。"
...
高净值私域宣传不是普通理财广告，也不是产品促销图，而是一种具有：
...
## 10. AI Image Tool Compatibility Rules

### 10.1 Tool Compatibility Goal
...
### 10.3 Universal Prompt Structure
...
### 10.6 Layout-safe Background Requirements
...
### 10.7 Tool-specific Prompt Adaptation
...
## 14. Default Generation Strategy
...
## 18. Background-only AI Prompt Template
...
## 20. Tool-specific Quick Prompt Guide
