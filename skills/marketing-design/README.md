...
保险产品 UI / H5、Hero、保险 Icon、插画、人物、信息可视化与内容审核
...
医疗险、重疾险、意外险、保险产品、保障方案、投保引导、保险 Hero / Icon / 插画 / 人物
...
默认继承 qieman-ui-design，不另起一套基础 UI Token。



用户提供的标准文案、官方产品材料优先于营销表达。



保额、保费、免赔额、报销比例、等待期、保障责任、免责、续保条件等关键事实不得擅自修改。



保险页面优先表达“这是什么、适合谁、保什么、怎么用、有什么限制”。



不使用股票、K 线、收益曲线、交易盘面作为保险页面默认主视觉。
...
仅对尚未完成、尚未提供 SKILL.md 的新 Skill使用 WIP 占位规则。
...
qieman-insurance-design 已具备正式 SKILL.md，当前状态为可用，不再属于 WIP。
