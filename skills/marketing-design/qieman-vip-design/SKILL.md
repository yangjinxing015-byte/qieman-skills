...
### V0.1.13 Visual Enrichment 更新重点

本版本针对高净值观点型九宫格的真实业务反馈，新增 **金融元素适度引入** 与 **尊贵身份素材补充** 规则。

核心调整：

* 保持“主题先行、强隐喻、克制高级”的主方向不变。
* 不再绝对排除所有金融元素，而是允许加入 **少量、简洁、非直白的金融元素**。
* 允许在部分格子中加入体现高净值身份的高端素材，用于强化“圈层、尊贵、顶级玩家、长期主义、认知优势”等语义。
* 新增“顶级玩家类素材”参考，如：围棋、棋子、邀请函、专属席位、私享门厅、徽章、资产视角卡片等。
* 要求所有新增元素仍需服从“图文可读、画面克制、缩略图清晰”的总原则。

本版本的重要原则是：

```txt
不是禁止金融元素，
而是禁止低质、低级、过满、直白的金融元素。
...
## Subtle Financial Elements Rule

在高净值观点型九宫格中，不要求完全排除所有金融元素。

当主题需要强化“认知、信息、投资、结构、资产、长期主义、视角、圈层价值”时，允许加入 **少量、简洁、非直白的金融元素**。

### 允许的金融元素方向

允许使用以下“轻金融元素”作为辅助视觉，但不得形成廉价金融广告风格：
...
* 结构 / 配置 / 风控 / 视角 等关键词提示
* 极简金融信息面板
* 投资逻辑提示语，如 `asset allocation` / `long-term` / `market insight` / `risk control`
...
* 每格最多加入 1–2 处辅助金融元素。
* 不得堆叠成复杂数据屏。
* 不得出现密集 K 线、红绿涨跌盘、交易软件界面、夸张收益图。
* 金融元素应更像“研究视角 / 资产思考 / 结构化信息”，而不是“炒股界面”。
...
## Premium Identity Props Rule

在高净值观点型视觉中，允许加入能够体现“尊贵身份、顶级玩家、圈层门槛、长期主义、认知博弈”的高端素材。

这些素材不应显得炫富，而应体现“克制、审慎、稀缺、判断力”。
...
| 素材 | 适合表达 |
|---|---|
| 围棋 / 国际象棋 | 顶级玩家、结构思维、长期布局、认知博弈 |
| 邀请函 / 印章 | 门槛、准入、私享、筛选 |
| 空席 / 私享会客区 | 圈层、位置、身份认同、同频对话 |
| 半开门 / 门厅 | 择人而入、席位有限、被邀请进入 |
| 钢笔 / 研究桌面 | 决策、判断、研究能力、专业感 |
| 徽章 / 定制卡片 | 身份确认、圈层象征、稀缺权益 |

### 使用原则

* 高端素材应服务于观点，不是单纯装饰。
* 每格尽量只保留 1 个核心高端素材。
* 不要堆砌豪车、豪宅、香槟、金表等俗奢元素。
* 高级感应来自克制的材质、灯光、留白和隐喻，而不是炫耀。

---

## Financial + Premium Balance Rule

当画面同时包含“轻金融元素”和“高端身份素材”时，必须遵循平衡原则，避免元素过多导致画面失焦。
...
* 1 个主符号 + 1 处金融辅助元素
* 1 个主符号 + 1 个高端身份素材
* 1 个主符号 + 少量金融辅助 + 少量身份暗示

### 不推荐

* 一个格子里同时出现过多图表、地图、卡片、棋子、门厅、椅子等。
* 把“金融感”和“身份感”都做得很满。
* 让辅助元素压过文案和主视觉。
...
## Recommended Visual Motif Mapping for VIP Nine-grid

当高净值观点型九宫格进入 Direct-demand 模式时，优先为每格匹配“主隐喻 + 金融辅助 + 身份暗示”的轻量组合。
...
### VIP Nine-grid Visual Enrichment Prompt Add-on

当用户希望“在当前高净值观点型九宫格方向上，适当加入一些简洁金融元素和高端身份素材”时，可附加以下要求：

* 保持整体深蓝黑金、高级、克制、强隐喻风格。
* 每格仍以一个主符号为核心。
* 可适当加入少量简洁金融元素，如：
  - 低密度走势线
  - 资产配置圆环
  - 全球资产视角轮廓
  - `insight` / `market` / `long-term` / `risk control` 等提示卡
  - 点阵网络与结构化金融信息
* 可适当加入高端身份素材，如：
  - 围棋 / 围棋棋子
  - 国际象棋 / 单棋子
  ...
  - 徽章 / 定制卡片 / 研究桌面
* 所有新增元素必须轻量、克制，不可堆满。
* 不能出现复杂金融大屏、密集 K 线、金币、交易界面、炫富元素。
* 目标是增强“金融专业感 + 高净值尊贵感”，而不是削弱原有的观点隐喻表达。
...
## V0.1.13 Practical Note

本版本新增的 Visual Enrichment 规则，主要解决以下实际问题：

* 观点型九宫格过于极简时，容易缺少金融语境。
* 完全排除金融元素后，画面容易变成纯抽象观点卡，与高净值投资场景的联系不够强。
* 高净值用户视觉不应只靠黑金色调，而应通过克制的身份素材传达“尊贵、顶级玩家、长期布局、圈层准入”。
* 金融元素与身份素材都应该作为辅助层存在，不能抢占文案与主符号。

因此，V0.1.13 的重点是：在保持高级克制的基础上，增强“金融专业感 + 高净值身份感”。
